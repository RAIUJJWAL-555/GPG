    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-6 py-3 text-white rounded-full shadow-lg hover:shadow-xl transition-shadow cursor-pointer" style={{ backgroundColor: '#0B1C2D' }}>
